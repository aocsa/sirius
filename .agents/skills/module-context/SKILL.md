...
Module docs are pre-generated at `.Codex/skills/module-discover/docs/`. Each library has:
...
1. Read the module's `.md` file from `.Codex/skills/module-discover/docs/<library>/modules/<module>.md`
