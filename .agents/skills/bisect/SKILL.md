...
**Reference:** See `.Codex/skills/_shared/build-and-query.md` for shared infrastructure (build modes, query execution, result comparison, change tracking).
...
5. **Execute automated bisect:**
   ...
   git bisect run /tmp/Codex-1000/sirius_bisect_test.sh
   ```
