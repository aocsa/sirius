...
**Reference:** See `.Codex/skills/_shared/build-and-query.md` for shared infrastructure (build modes, query execution, autonomy mode, change tracking, debug log conventions).
